...
public class LocatorsExample extends BaseTest {
	...
	public void tagNameLocator() {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", emText);
	...
	public void linkTextLocator() {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", booksLink);
		booksLink.click();
	...
	public void partialLinkTextLocator() throws InterruptedException {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", cookingBook);
		cookingBook.click();
	...
	public void classNameLocator() {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", productPrice);
	...
	public void idLocator () {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", comment);
	...
	public void checkBoxTest() throws InterruptedException {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", checkbox);

		
		//jsExecutor.executeScript("arguments[0].setAttribute('disabled', '')", checkbox);
		Thread.sleep(4000);
	...
	public void xpathLocator() throws InterruptedException {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", commentField);
	...
	public void nameLocator() throws InterruptedException {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", nameField);
