...
public class CssSelectorsExample extends BaseTest{
	...
	public void cssSelector1() {
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:yellow; border:4px solid red;')", loginPopup);
		...
		jsExecutor.executeScript("arguments[0].setAttribute('style', 'background:orange; border:4px solid red;')", logoSlogan);
